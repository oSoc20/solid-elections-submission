        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse order-2 order-lg-1 dual-collapse2">
                <ul id="navbar-left-side" class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Solid Pod</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="collapse navbar-collapse order-1 order-lg-2 dual-collapse2">
                <ul id="navbar-right-side" class="navbar-nav ml-auto order-1 order-lg-2">
                    <LoggedIn>
                        <li class="nav-item">   
                            <span class="nav-link"><Link href="user"> Welcome, <Value src="user.name"/></Link></span>
                        </li>
                    </LoggedIn>
                    <li class="nav-item">
                        <button class="nav-link btn"><AuthButton popup="/popup.html" login="Log in" logout="Log out"/></button>
                    </li> 
                </ul>
            </div>
        </nav>
