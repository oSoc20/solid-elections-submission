    ...
    return (
      <div class="vl-grid">
        <div className="form-group vl-form-col--6-12">
            <label className="vl-form__label" htmlFor={this.props.prefix + 'firstname'}>First name :</label>
        ...
        <div className="form-group vl-form-col--6-12">
            <label className="vl-form__label" htmlFor={this.props.prefix + 'lastname'}>Last name :</label>
        ...
        <div className="form-group vl-col--12-12--m vl-col--10-12">
            <label className="vl-form__label" htmlFor={this.props.prefix + 'street'}>Street :</label>
        ...
        <div className="form-group vl-col--12-12--m vl-col--2-12">
            <label className="vl-form__label" htmlFor={this.props.prefix + 'streetNumber'}>Number :</label>
        ...
        <div className="form-group vl-col--12-12--m vl-col--10-12">
            <label className="vl-form__label" htmlFor={this.props.prefix + 'locality'}>Locality :</label>
        ...
        <div className="form-group vl-col--12-12--m vl-col--2-12">
            <label className="vl-form__label" htmlFor={this.props.prefix + 'postalCode'}>Postal Code :</label>
