...
export default function Header() {
  return (
    <header className="vl-content-header vl-content-header--large vl-content-header--has-logo vl-content-header--show-mobile">
      <div className="vl-content-header__wrapper">
        ...
        <div className="vl-layout">
          <div className="vl-content-header__content">
            <div className="vl-content-header__line vl-content-header__line-1"></div>
            <div className="vl-content-header__line vl-content-header__line-2 js-vl-content-header__line-2"></div>
            <div className="vl-content-header__line vl-content-header__line-3 js-vl-content-header__line-3"></div>
            <div className="vl-content-header__logo">
              <div className="vl-content-header__logo__img">
                <svg
                  role="img"
              ...
              <div className="vl-content-header__logo__text">
                <div className="vl-content-header__logo__title">
                  Vlaanderen
                  <span className="vl-content-header__logo__tagline">Elections</span>
                </div>
              </div>
            </div>
          </div>
