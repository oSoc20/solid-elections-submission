    ...
    return (
      <div className="vl-grid">
        ...
        <div className="form-group vl-form-col--6-12">
            ...
            <p className="vl-form__error" id={'input-field-' + this.props.prefix + 'lastname-error'}></p>
        </div>
        ...
        <div className="form-group vl-col--12-12--m vl-col--10-12">
            ...
            <p className="vl-form__error" id={'input-field-' + this.props.prefix + 'street-error'}></p>
        </div>
        ...
        <div className="form-group vl-col--12-12--m vl-col--2-12">
            ...
            <p className="vl-form__error" id={'input-field-' + this.props.prefix + 'streetNumber-error'}></p>
        </div>
        ...
        <div className="form-group vl-col--12-12--m vl-col--10-12">
            ...
            <p className="vl-form__error" id={'input-field-' + this.props.prefix + 'locality-error'}></p>
        </div>
